function [meda_map,meda_dis,ord,Lmodel] = meda_Lpca(Lmodel,thres,opt,vars)
...
%
% [meda_map,meda_dis,ord,Lmodel] = meda_Lpca(Lmodel) % minimum call
% [meda_map,meda_dis,ord,Lmodel] = meda_Lpca(Lmodel,thres,opt,vars) %complete call
%
%
% INPUTS:
%
