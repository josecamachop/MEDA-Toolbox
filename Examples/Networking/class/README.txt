...
Last modification of this document: 10/Jul/13

References:

 Data set and Analisys: 

   J. Camacho. Networkmetrics: Multivariate Visual Analytics for Time Series Networking Data. 
...
- class_com.m: Script to perform the EDA using the EDA 2.0 toolbox commands.
