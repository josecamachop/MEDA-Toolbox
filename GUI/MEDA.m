...
h = msgbox({strcat('Version number: ',handles.data.version),'','Main Authors:','Code: JosÈ Camacho (jcamacho@ugr.es)','GUI: Rafael A. RodrÌguez-GÛmez (rodgom@ugr.es)'},'About','custom',myicon);