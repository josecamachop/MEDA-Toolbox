function [AUC,nze] = crossvalSplsDA(x,y,varargin)
...
%
% AUC = crossvalSplsDA(x,y) % minimum call
%
%
% See also: crossvalSpls, crossvalPls, crossvalPca
%
%
% INPUTS:
%
