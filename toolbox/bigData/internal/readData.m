function [data,label,class,lev,s]=readData(name,path,nvars,debug)

% Read the data from a file in the clustering file system.  
%
% [data,label,class,lev,s]=readData(name,path,nvars) % minimum call
% [data,label,class,lev,s]=readData(name,path,nvars,debug) % complete call
%
%
% INPUTS:
%
